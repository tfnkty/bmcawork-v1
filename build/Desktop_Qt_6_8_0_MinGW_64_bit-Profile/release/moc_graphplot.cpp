...
struct qt_meta_stringdata_CLASSGraphplotENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSGraphplotENDCLASS = QtMocHelpers::stringData(
    "Graphplot",
    "setNrOfChannels",
    "",
    "iNrOfChannels",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGraphplotENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Graphplot::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSGraphplotENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSGraphplotENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGraphplotENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Graphplot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSGraphplotENDCLASS.stringdata0))
