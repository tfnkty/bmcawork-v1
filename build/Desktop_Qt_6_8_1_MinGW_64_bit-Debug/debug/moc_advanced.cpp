...
namespace {
struct qt_meta_tag_ZN8AdvancedE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN8AdvancedE = QtMocHelpers::stringData(
    "Advanced",
    "showEvent",
    "",
    "QShowEvent*",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8AdvancedE[] = {
...
Q_CONSTINIT const QMetaObject Advanced::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8AdvancedE.offsetsAndSizes,
    qt_meta_data_ZN8AdvancedE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8AdvancedE_t,
        // Q_OBJECT / Q_GADGET
...
void *Advanced::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8AdvancedE.stringdata0))
